...
The answer is (b). 
Use $prize_{i},choose_{i},open_{i}$ to denote the event that the prize is in/the player chooses/the host opens the $i$-th box. 
Apply Bayes's rules:
\begin{align}
\text{Pr}(prize_{1}|choose_{1},open_{3})=&\frac{\text{Pr}(choose_{1})\text{Pr}(prize_{1})\text{Pr}(choose_{3}|prize_{1},choose_{1})}{\text{Pr}(choose_{1})\text{Pr}(open_{3}|choose_{1})}\nonumber \\
=&\frac{\text{Pr}(prize_{1})\text{Pr}(choose_{3}|prize_{1},choose_{1})}{\text{Pr}(open_{3}|choose_{1})}\nonumber \\
